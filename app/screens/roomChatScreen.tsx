...
import Animated, { FadeInDown, useSharedValue, useAnimatedStyle, withTiming, FadeInUp } from "react-native-reanimated";
  ...
  return (
    <View className="flex-1">
      <View className="bg-[#1475BA] flex-row w-full items-center px-4 py-4 rounded-b-[10px] shadow-md gap-4">
        ...
        <View className="flex-1">
          <Text style={{ fontFamily: "LexBold" }} className="text-lg text-white">
            Stasiun Meteorologi
          </Text>
