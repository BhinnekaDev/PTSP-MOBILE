    ...
    <View className="flex-1 bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="w-full p-5">
          {/* HEADER TRACKING PESANAN */}
          <View className="mb-8 items-center rounded-2xl bg-[#1475BA] p-5 shadow-sm">
            {/* ID Pesanan */}
            <View className="mb-3 self-center rounded-full border border-white/30 bg-white/20 px-3 py-1 backdrop-blur-sm">
            ...
            {detail.user?.tipe === 'perorangan' && (
              <View className="mt-4 gap-3 space-y-3">
                ...
                <View className="flex-row items-center rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
                  ...
                  <View>
                    <Text className="text-xs text-gray-500">Nama Lengkap</Text>
            ...
            {detail.user?.tipe === 'perusahaan' && (
              <View className="mt-4 gap-3 space-y-3">
                ...
                <View className="flex-row items-center rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
                  ...
                  <View>
                    <Text className="text-xs text-gray-500">Email Pribadi</Text>
                    <Text className="text-sm text-gray-800">
                      {detail.user.Email}
                    </Text>
                  </View>
          ...
          <View className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <View className="mb-5 flex-row items-center justify-between">
              <View className="flex-row items-center gap-2">
                <Ionicons name="receipt-outline" size={18} color="#0A7F3F" />
                <Text className="font-semibold text-gray-800">
                  Detail Pesanan ({detail.keranjang.length}{' '}
                  {detail.keranjang.length > 1 ? 'Produk' : 'Produk'})
                </Text>
              </View>
            ...
            >
              {detail.keranjang.map((item, index) => (
                <View
                  key={index}
                  className="gap-2 rounded-xl border border-gray-100 bg-white p-4 shadow-sm"
                >
