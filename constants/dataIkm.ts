...
export const stepsData = [
  ...
  [
    { title: 'Keberadaan petugas layanan jelas' },
    { title: 'Petugas sigap, ahli dan cekatan' },
    {
      title: 'Sikap dan perilaku petugas pelayanan baik dan bertanggung jawab',
    },
    {
      title: 'Sarana dan prasarana pelayanan aman, nyaman dan mudah dijangkau',
    },
    { title: 'Pelayanan publik pada instansi ini sudah berjalan dengan baik' },
  ],
];

// Untuk Kualitas Pelayanan
export const optionsKualitas = [
  'Sangat Setuju',
  'Setuju',
  'Kurang Setuju',
  'Tidak Setuju',
